...
class CreateLinkRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["url", "team_id", "folder_id", "domain", "code", "label", "tags", "password", "qrcode", "utm", "metatag", "geolinks", "delete_at", "expired_at", "expired_url", "delete_after_expiration"]
