...
class DomainsApi:
    ...
    def create_domain(
        self,
        create_domain_request: Annotated[Optional[CreateDomainRequest], Field(description="You can use this endpoint to add a custom domain to URLR.")] = None,
        ...
        :param create_domain_request: You can use this endpoint to add a custom domain to URLR.
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CreateDomain200Response",
            '401': "GetLink401Response",
            '429': "CreateLink429Response",
            '409': "CreateDomain409Response",
        }
    ...
    def create_domain_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateDomain200Response]:
        """Create a domain
