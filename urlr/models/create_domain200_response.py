...
class CreateDomain200Response(BaseModel):
    """
    CreateDomain200Response
    """ # noqa: E501
    domain: Optional[StrictStr] = Field(default=None, description="Domain")
    root_url: Optional[StrictStr] = Field(default=None, description="Redirect URL for the root of the domain")
    __properties: ClassVar[List[str]] = ["domain", "root_url"]
